...
describe('sanitizeHtml', function() {
  ...
  it('Allowed class WILDCARD should only match one or more things (not zero or more)', function() {
    assert.equal(
      sanitizeHtml(
        '<p class="nifty- nifty-a simple dippy">whee</p>',
        {
          allowedTags: [ 'p' ],
          allowedClasses: {
            p: [ 'nifty-*' ]
